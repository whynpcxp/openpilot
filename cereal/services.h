...
static struct service services[] = {
  ...
  { "driverStateV2", 8043, true, 20, 10 },
  { "wideRoadEncodeIdx", 8044, false, 20, 1 },
  { "wideRoadCameraState", 8045, true, 20, 20 },
  { "modelV2", 8046, true, 20, 40 },
  { "managerState", 8047, true, 2, 1 },
  { "uploaderState", 8048, true, 0, 1 },
  { "navInstruction", 8049, true, 1, 10 },
  { "navRoute", 8050, true, 0, -1 },
  { "navThumbnail", 8051, true, 0, -1 },
  { "navModel", 8052, true, 2, 4 },
  { "mapRenderState", 8053, true, 2, 1 },
  { "uiPlan", 8054, true, 20, 40 },
  { "qRoadEncodeIdx", 8055, false, 20, -1 },
  { "userFlag", 8056, true, 0, 1 },
  { "microphone", 8057, true, 10, 10 },
  ...
  { "driverCameraState", 8064, true, 10, 10 },
  { "driverEncodeIdx", 8065, false, 10, 1 },
  { "driverState", 8066, true, 10, 5 },
  { "driverMonitoringState", 8067, true, 10, 5 },
  { "sensorEvents", 8068, true, 100, 100 },
  { "dragonConf", 8069, false, 1, -1 },
  { "liveMapData", 8070, true, 0, -1 },
};
#endif
